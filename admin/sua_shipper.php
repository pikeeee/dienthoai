...
?>
<form action="update_sua_shipper.php" method="post" name="frm" onsubmit="return kiemtra()" enctype="multipart/form-data">
	<table>
			<tr class="tieude_themsp">
				<td colspan=2>Cập nhật thông tin cá nhân</td>
			</tr>
    		<tr>
            ...
            <tr>
            	<td>Password</td><td><input type="text" name="pass"  value="<?php echo $row['password'] ?>"/></td>
            </tr>
			<tr>
